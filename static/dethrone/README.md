...
- **Action card hand** — visible hand strip on the play screen, **Hand** tab with full grid + play buttons, V3b deck-coloured card stubs (`cards-action.js`); draw toasts, duel/vote card stubs in helpers, parley row on your turn
