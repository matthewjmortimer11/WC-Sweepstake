...
PACKS: dict[str, dict] = {
    ...
    "brutal": {"name": "Brutal", "description": "Dictators, bunkers, black sites, and history with the lights off."},
}
...
LOCATIONS.extend([
    ...
    {"id": "hitlers-bunker", "pack": "brutal", "name": "Hitler's Bunker", "category": "Brutal / Collapse", "texture": "Concrete walls, stale air, maps nobody believes, and the city shaking overhead.", "roles": ["Radio Operator", "Secretary", "Guard", "Courier", "Doctor", "Cook", "General", "Archivist"], "questions": ["What order no longer matters?", "What sound means the city is falling?", "Who is pretending there is still a plan?"]},
    {"id": "auschwitz-memorial-archive", "pack": "brutal", "name": "Auschwitz Memorial Archive", "category": "Brutal / Remembrance", "texture": "Quiet rooms, preserved records, guarded silence, and history that must not be softened.", "roles": ["Archivist", "Historian", "Guide", "Conservator", "Educator", "Researcher", "Security", "Visitor"], "questions": ["What must be handled with care?", "What detail should never be forgotten?", "Who makes sure people speak respectfully?"]},
    {"id": "pyongyang-state-hotel", "pack": "brutal", "name": "Pyongyang State Hotel", "category": "Brutal / Surveillance", "texture": "Empty corridors, perfect smiles, forbidden floors, and cameras tucked into the calm.", "roles": ["Guide", "Translator", "Guest", "Doorman", "Floor Attendant", "Photographer", "Security Officer", "Diplomat"], "questions": ["What floor should nobody visit?", "Who is listening too closely?", "What answer sounds rehearsed?"]},
    {"id": "dmz-negotiation-hut", "pack": "brutal", "name": "DMZ Negotiation Hut", "category": "Brutal / Standoff", "texture": "A table on a fault line, polished microphones, soldiers outside, and every chair measured twice.", "roles": ["Interpreter", "General", "Observer", "Journalist", "Protocol Officer", "Guard", "Mediator", "Camera Operator"], "questions": ["What line must not be crossed?", "Who chooses every word carefully?", "What gesture could ruin the meeting?"]},
    {"id": "propaganda-broadcast-studio", "pack": "brutal", "name": "Propaganda Broadcast Studio", "category": "Brutal / Control", "texture": "Red lights, forced applause, edited truth, and a script nobody is allowed to question.", "roles": ["Anchor", "Censor", "Sound Engineer", "Party Official", "Camera Operator", "Guest", "Translator", "Stage Manager"], "questions": ["What word gets cut?", "Who is smiling too hard?", "What version of events goes on air?"]},
    {"id": "secret-police-archive", "pack": "brutal", "name": "Secret Police Archive", "category": "Brutal / Paranoia", "texture": "Grey folders, buzzing strip lights, names crossed out, and a drawer that should stay shut.", "roles": ["Clerk", "Investigator", "Informant", "Cleaner", "Archivist", "Driver", "Supervisor", "Translator"], "questions": ["Whose file is missing?", "What name should not be said?", "Who knows too much?"]},
    {"id": "black-site-interrogation-wing", "pack": "brutal", "name": "Black Site Interrogation Wing", "category": "Brutal / Disappearance", "texture": "No windows, humming vents, numbered doors, and paperwork designed to erase the room.", "roles": ["Guard", "Medic", "Lawyer", "Interpreter", "Analyst", "Cleaner", "Supervisor", "Driver"], "questions": ["What detail proves this place exists?", "Who refuses to sign?", "What sound keeps repeating?"]},
    {"id": "nuclear-launch-silo", "pack": "brutal", "name": "Nuclear Launch Silo", "category": "Brutal / Endgame", "texture": "Key slots, red phones, sealed hatches, and a checklist that makes everyone sweat.", "roles": ["Commander", "Technician", "Security", "Radar Operator", "Cook", "Engineer", "Inspector", "Communications Officer"], "questions": ["What button should never be pressed?", "Who checks the code twice?", "What alarm changes everything?"]},
    {"id": "dictators-parade-balcony", "pack": "brutal", "name": "Dictator's Parade Balcony", "category": "Brutal / Spectacle", "texture": "Marching boots, giant portraits, fake cheers, and binoculars scanning the crowd.", "roles": ["Bodyguard", "Announcer", "General", "Photographer", "Flag Bearer", "Translator", "Protocol Officer", "Engineer"], "questions": ["Who claps first?", "What is being hidden from the cameras?", "Who looks terrified of being noticed?"]},
    {"id": "oligarch-panic-room", "pack": "brutal", "name": "Oligarch Panic Room", "category": "Brutal / Money", "texture": "Steel doors, offshore ledgers, satellite phones, and art bought for the escape plan.", "roles": ["Accountant", "Bodyguard", "Lawyer", "Pilot", "Housekeeper", "Tech Consultant", "Fixer", "Family Member"], "questions": ["What gets shredded first?", "Who knows where the cash is?", "What luxury suddenly feels useless?"]},
    {"id": "coup-war-room", "pack": "brutal", "name": "Coup War Room", "category": "Brutal / Betrayal", "texture": "Pinned maps, dead phones, half-empty coffee, and allies changing sides by the minute.", "roles": ["Colonel", "Minister", "Aide", "Radio Operator", "Driver", "Journalist", "Bodyguard", "Lawyer"], "questions": ["Who flips first?", "What building matters most?", "Which call must be made before dawn?"]},
    {"id": "doomsday-cult-compound", "pack": "brutal", "name": "Doomsday Cult Compound", "category": "Brutal / Delusion", "texture": "Locked gates, canned food, handmade banners, and a leader with too many rules.", "roles": ["Leader", "Recruit", "Guard", "Cook", "Mechanic", "Medic", "Bookkeeper", "Runaway"], "questions": ["What rule makes no sense?", "Who wants out?", "What is hidden in the shed?"]},
])
